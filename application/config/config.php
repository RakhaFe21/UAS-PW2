...
|
*/
$config['base_url'] = 'http://localhost/UAS/'; // Ganti jika folder project berbeda
...
|
*/
$config['encryption_key'] = 'perpusci3key123'; // Kunci enkripsi session
...
| 'upload_path'
|
|	Folder upload file buku
|
*/
$config['allowed_types'] = 'pdf'; // Tipe file yang diizinkan untuk upload
$config['upload_path'] = './uploads/'; // Folder upload file buku
